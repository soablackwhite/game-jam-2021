...
public class @TwoPlayerActionControl : IInputActionCollection, IDisposable
{
    public InputActionAsset asset { get; }
    public @TwoPlayerActionControl()
    {
    ...
    {
        private @TwoPlayerActionControl m_Wrapper;
        public MainActions(@TwoPlayerActionControl wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @TwoPlayerActionControl m_Wrapper;
        public SecondaryActions(@TwoPlayerActionControl wrapper) { m_Wrapper = wrapper; }
